...
import bece from "./assets/images/bc.png";
            ...
            <div class="col-md-6 order-md-1" data-aos="fade">
              <div class="text-left pb-1 border-primary mb-4">
                <h2 class="text-primary">
                  {" "}
                  “effortlessly cater the need of the bulk/breakbulk “
                </h2>
              </div>
              <p>
                We can also effortlessly cater the need of the bulk/breakbulk
                cargo consignments . <br />
                And our expertise team with the past experience make the entire
                shipping journey a worry-free task .<br />
                Also, the technical aspects to the nature of the cargo is
                determined for the safe and sound shipment by following the
                shipping standards .<br />
                <br />
                <b>Best stevedore partnership</b> <br />
                <b>On time service</b>
                <br />
                <b>Break bulk vessel arrangement</b> <br />
                <b>Dismantling service</b> <br />
                <b>Cost efficient handling</b> <br />
                <b>Yard to drayage services</b> <br />
              </p>
            </div>
          </div>
        </div>
