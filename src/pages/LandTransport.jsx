          ...
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              ...
              <p class="breadcrumb-custom">
                ...
                <span>Land Transportation And Stuffing</span>
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-6 order-md-1" data-aos="fade">
              <div class="text-left pb-1 border-primary mb-4">
                <h2 class="text-primary">
                  {" "}
                  “ we keep your consignment connected and filled “
                </h2>
              </div>
              <p>
                To ensure the safe movement between the nodes we also work on
                providing the logistical support for the road freight .Also our
                robust knowledge about the nature , dimensions of the cargos is
                of great use in consolidation , selection of trailer trucks and
                in getting the cargos comfortably stuffed for the shipment .
                <br />
                <br />
                <b>Networked with truck fleet providers</b>
                <br />
                <b>World class CFS </b>
                <br />
                <b>Comprehensive solution for road movement </b>
                <br />
              </p>
            </div>
          </div>
