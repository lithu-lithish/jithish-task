        ...
        <div class="container">
          <div class="row mb-5">
            ...
            <div class="col-md-6 order-md-1" data-aos="fade">
              <p>
                Food and Agro industry require a fast and personal touch during
                the journey of the supply chain. While it is important to
                deliver your food and Agro produce on time, it is also critical
                to preserve the quality of the goods during the entire movement.
                Your customers need those goods for their nourishment because it
                is because they trust your reputation.
                <br />
                <br /> MEK offer customized freight solutions for all types of
                your goods. Dry food cargo, Liquid, Fresh, Frozen and or
                Processed, we carry your goods to the market on time every time.
                From Foods and Beverages to the machinery involved in the food
                industry we help you bring the food to the table with quality
                that is compliant to the international trade and practices.
              </p>
            </div>
          </div>
        </div>
