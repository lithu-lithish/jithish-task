...
import cerr from "./assets/images/cr.png";
import logo from "./assets/images/logo.png";
import hero4 from "./assets/images/hero_bg_4.jpg";
import { NavLink } from "react-router-dom";
export default function CustomerRel() {
  return (
    <div class="site-wrap">
      ...
      <div
        ...
        style={{ backgroundImage: "url(" + cerr + ")" }}
        data-aos="fade"
            ...
            <div class="col-md-6 order-md-1" data-aos="fade">
              <div class="text-left pb-1 border-primary mb-4">
                <h2 class="text-primary">
                  {" "}
                  “ customers are the emotion of our brand “
                </h2>
              </div>
              <p>
                We at MEK Global Concepts, be with you and your consignments
                until the destiny is reached .And we do have consistent updates
                on opportunities ,resources available in the global market to
                achieve a win -win position .
                <br />
                <br />
                <b>Round the clock service</b>
                <br />
                <b> Regular follow-up’s</b>
                <br />
                <b>100% approachable & reachable </b>
                <br />
                <b> Swift response to enquiry </b>
                <br />
              </p>
            </div>
          </div>
