            ...
            <div class="col-md-6 order-md-1" data-aos="fade">
              <div class="text-left pb-1 border-primary mb-4">
                <h2 class="text-primary">
                  {" "}
                  “ we can make your consignment to reach the unreachable “
                </h2>
              </div>
              <p>
                Our logistical service extends even to air freight service to
                make the time squeezed cargos for immediate delivery and safe
                shipment .And we ensure the ULD movement in a protected line to
                deliver the high valued cargos .
                <br />
                <br />
                <b>Timely delivery</b>
                <br />
                <b>Hassle -free documentation </b>
                <br />
                <b>Across the globe service </b>
                <br />
                <b> Partnered with Air freight station </b>
                <br />
                <b> Good carrier network </b>
                <br />
              </p>
            </div>
          </div>
