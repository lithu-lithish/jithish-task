  ...
  return (
    <div class="site-wrap">
      ...
      <div
        ...
        style={{ backgroundImage: "url(" + fas + ")" }}
        //  style="background-image: url(images/fas.png);"
        data-aos="fade"
        ...
        <div class="container">
          <div class="row mb-5">
            ...
            <div class="col-md-6 order-md-1" data-aos="fade">
              <p>
                MEK supply chain specialists understand the complexities of
                logistics in the fashion industry. With a global network of
                offices and knowledgeable professionals, MEK is positioned to
                effectively manage fashion logistics programs that ensure speed
                to market at competitive costs for the world’s leading fashion
                brands.
              </p>
            </div>
          </div>
