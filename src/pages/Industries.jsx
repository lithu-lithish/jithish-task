...
import indc from "./assets/images/indc.png";
  ...
  return (
    <div class="site-wrap">
      ...
      <div
        ...
        // style="background-image: url(images/indc.png);"
        style={{ backgroundImage: "url(" + indc + ")" }}
        data-aos="fade"
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="automotive.html" class="unit-1 text-center">
                <img
                ...
                <div class="unit-1-text">
                  <h3 class="unit-1-heading"> AUTOMOTIVE AND MOBILITY</h3>
                  <br />
                  <br />
                  <br />
                  <br />
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="fashion.html" class="unit-1 text-center">
                <img
                  src="assets/images/fas.png"
                  alt="Image"
                  class="img-fluid"
                />
                <div class="unit-1-text">
                  <h3 class="unit-1-heading">FASHION</h3>
                  <br />
                  <br />
                  <br />
                  <br />
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="pharma.html" class="unit-1 text-center">
                <img
                ...
                />
                <div class="unit-1-text">
                  <h3 class="unit-1-heading"> PHARMA</h3>
                  <br />
                  <br />
                  <br />
                  <br />
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="manufacturing.html" class="unit-1 text-center">
                <img
                ...
                />
                <div class="unit-1-text">
                  <h3 class="unit-1-heading"> MANUFACTURING</h3>
                  <br />
                  <br />
                  <br />
                  <br />
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="oil.html" class="unit-1 text-center">
                <img
                ...
                />
                <div class="unit-1-text">
                  <h3 class="unit-1-heading"> OIL & ENERGY</h3>
                  <br />
                  <br />
                  <br />
                  <br />
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="retail.html" class="unit-1 text-center">
                <img
                ...
                />
                <div class="unit-1-text">
                  <h3 class="unit-1-heading"> RETAIL </h3>
                  <br />
                  <br />
                  <br />
                  <br />
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="food.html" class="unit-1 text-center">
                <img
                ...
                />
                <div class="unit-1-text">
                  <h3 class="unit-1-heading"> FOOD & AGRO</h3>
                  <br />
                  <br />
                  <br />
                  <br />
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="technology.html" class="unit-1 text-center">
                <img
                ...
                />
                <div class="unit-1-text">
                  <h3 class="unit-1-heading"> TECHNOLOGY </h3>
                  <br />
                  <br />
                  <br />
                  <br />
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="minerals.html" class="unit-1 text-center">
                <img
                ...
                />
                <div class="unit-1-text">
                  <h3 class="unit-1-heading"> MINERALS </h3>
                  <br />
                  <br />
                  <br />
                  <br />
